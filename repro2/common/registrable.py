# This class is copied from the implementation AllenNLP. We chose to copy
# the file instead of add AllenNLP as a dependency because its too large of
# a dependency to add for just using the Registrable and FromParams logic.
"""
...
from repro2.common import ConfigurationError
